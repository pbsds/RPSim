# downloaded from http://pygame.org/project-EzText-920-.html
# with minor aliasing and buffer edits by pbsds
...
class Input:
    ...
    def draw(self, surface):
        ...
        if self.oldValue <> self.value:
            ...
            self.render = self.font.render(self.prompt+self.value, 0, self.color)
        surface.blit(self.render, (self.x, self.y))
